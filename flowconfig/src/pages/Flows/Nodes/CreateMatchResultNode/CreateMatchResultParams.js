...
export default function CreateMatchResultParams({node}){
    ...
    return (
      <>
        <Row className="param-panel-row" gutter={24}>
            <Col className="param-panel-row-label" span={10}>Match Result</Col>
            <Col className="param-panel-row-input" span={14}>
        ...
        <Row className="param-panel-row"  gutter={24} style={{display:showGroupModel?"flex":"none"}}>
            <Col className="param-panel-row-label level-1" span={10}>Model ID</Col>
            <Col className="param-panel-row-input" span={14}>
